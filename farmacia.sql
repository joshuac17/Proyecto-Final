...
-- UNION Y RESTRICCIONES CLAVES SECUNDARIAS 
  ...
  alter table clientes 
  add constraint uni_DPI unique(DPI)
...
--RESTRICCIONES VALIDACION DE CAMPOS 
  ...
  alter table clientes add constraint CK_DPI CHECK(LEN(DPI)=8)


select * from Distrito
insert into Distrito values ('062','GUATEMALA'),
                            ('065','PETEN'),
                            ('034','IZABAL'),
                            ('054','CHIMALTENANGO'),
                            ('056','JALAPA')
...
insert into Empleado values('24360992','PEDRO VEGA','GUATEMALA S/N','065','ADMIN','24',8346543,997287215,'','1234'),
                           ('65646454','LUIS CASTILLO','GUATEMALA S/N','034','SERVI','24',8346543,137287223,'','1234'),
                           ('94364339','ERIK BARRONDO','GUATEMALA S/N','054','SERVI','94',9994576,137987923,'','1934'),
                           ('94360139','FREDY GONZALES','GUATEMALA S/N','056','SUPERVISOR','94',9994556,137987223,'','1234'),
                           ('20140152','HARRY POTTER','GUATEMALA S/N','062','SUPERVISOR','24',8346543,137287431,'','1234'),
                           ('20566162','MANOLO GUERRA','GUATEMALA S/N','065','FARMACEUTICO','24',2224562,137287253,'','1234'),
                           ('28748376','JOSE PEREZ','GUATEMALA S/N','034','FARMACEUTICO','24',2224561,997287215,'','1234')
select * from Usuario
...
insert into Presentacion values('0026','HARRY POTTER'),
                               ('0027','RUFUEL SOTO'),
                               ('0028','ANGEL ANGUILA'),
